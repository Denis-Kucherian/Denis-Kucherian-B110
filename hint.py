...
def generate_unique_numbers(count, minbound, maxbound):     # генерировать уникальные номера из интервала
...
class Card:                 # карточка
    ...
    def __init__(self):
        uniques_count = self.__nums_in_row * self.__rows            # количество чисел в карточке (15)
        uniques = generate_unique_numbers(uniques_count, 1, 90)     # список из 15 случайных неодинаковых чисел
